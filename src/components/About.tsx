      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                ...
                <p>Every project is an Opportunity to solve problems creatively, tell meaningful stories, and build something that not only looks amazing but also drives real results.</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {services.map((service, index) => <div key={index} className="neu-card p-6 group cursor-pointer" style={{
